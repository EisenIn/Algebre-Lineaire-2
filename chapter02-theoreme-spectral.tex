...
\begin{definition}
  ...
  \begin{itemize}
  \item définie positive, si et seulement si $x^TAx>0$ pour tout $x \in \R^n \setminus  \{0\}$ 
  \item définie négative, si et seulement si $x^TAx<0$ pour tout $x \in \R^n \setminus  \{0\}$ 
  \item semi-définie positive, si et seulement si $x^TAx\geq 0$ pour tout $x \in \R^n$ 
  \item semi-définie négative, si et seulement si $x^TAx\leq 0$ pour tout $x \in \R^n$.  
  \end{itemize}
