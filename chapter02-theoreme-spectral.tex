...
\begin{remark}
La même preuve, par le théorème fondamental de l'algèbre, montre en fait que $A$ possède $n$ valeurs propres réelles (en comptant les racines multiples), ou de manière équivalente, que le polynôme caractéristique de $A$ est scindé sur $\Bbb R$. 
\end{remark}
