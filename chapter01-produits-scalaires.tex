...
\begin{definition}
  \label{def:37}
  Pour un espace vectoriel sur $ℝ$ de dimension finie, on appelle une base $B$ de $V$ telle que $A_B^{\pscal{,}}$ à la forme décrite en~\eqref{eq:5} une \emph{base de Sylvester}. 
\end{definition}
