...
pour tout $v \in V$ $\pscal{v,v} \in \R$ des que  $\pscal{v,v} = \overline{\pscal{v,v}}$.  On dit que la forme hermitienne   est \emph{défini positif} si $\pscal{v,v} >0$ pour tout $v \in V \setminus\{0\}$. 
\end{remark}
