...
\begin{remark}
  \label{sec:valeurs-propres-et-1}
  Une valeur propre n'est pas égale a zéro.
\end{remark}
...
\begin{definition}
  \label{def:39}
  Un endomorphisme $f ：V ⟶ V$ pour lequel il existe une base de vecteurs propres est \emph{diagonalisable}.
\end{definition}
...
\begin{proof}
  ...
  \end{equation}
  et supposons que $α_1≠0$ et $α_r ≠0$. Autrement on réarrange  les $v_1,\dots,v_r$.
  ...
  \end{equation}
  On soustrait \eqref{eq:37} de \eqref{eq:35}, on obtient
  \begin{displaymath}
