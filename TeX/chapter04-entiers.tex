...
\label{sec:la-forme-normale-smith}
  ...
  \end{theorem}
  La matrice~\eqref{eq:58} est la \emph{forme normal de Smmith} de $A$. 
\begin{proof}
  ...
  \begin{equation}
    ...
    Par récurrence, $B$ possède une forme normale Smith et ses composantes sont tous de multiples de $d$. 
