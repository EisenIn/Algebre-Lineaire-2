...
Dans cette section, nous fournirons une preuve du Théorème~\ref{thr:58}. Soit $R$ un anneau. Une \emph{suite} est une fonction $σ: ℕ_0 ⟶ R$. Nous écrirons $σ$ comme
\begin{displaymath}
  σ = [a_0,a_1,a_2, \dots ),
\end{displaymath}
...
\begin{displaymath}
  [1,0,0, \dots). 
\end{displaymath}
Cela montre que $S$ est un anneau. L'élément $x ∈ S$ spécifié dans le Théorème~\ref{thr:58} est la suite
 \begin{displaymath}
 x =  [0,1,0, \dots). 
\end{displaymath}
