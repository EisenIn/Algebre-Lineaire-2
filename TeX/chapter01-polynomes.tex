 ...
 Alors  si $p$ est unitaire,  $p$ est unique. 
  ...
  \subsubsection*{Probabilité d'échec}
   ...
   \begin{proof}
     ...
     $(p(x)/ \ell_1)(A) v =0$ soit vérifié. Considérons maintenant
...
\begin{tabbing}
\textbf{Entrée:} $A ∈ K^{n ×n}$, $k ∈ ℕ_+$, $S ⊆ K$ t.q. $|S| = 2n$ \\
...
\end{theorem}
   ...
   \item Soit  $A ∈ K^{ n ×n}$. 
     \begin{enumerate}[i)]
     \item        Montrer que l'ensemble $I = \{ f(x) \in K[x] \mid f(A) = 0\}$ est un idéal de $K[x]$ et qu'il est engendré par le polynôme minimal de $T$.      \label{item:1}
     \item   Soit $v \in V$. Montrer que l'ensemble $I = \{ f(x) \in K[x] \mid f(A)v = 0\}$ est un idéal de $K[x]$ et que celui-ci est engendré par $p_v(x)$, le $A$-annulateur de $v$. \label{item:2}
     \item Montrer que $p(x)$ est le plus petit commun multiple (des) polynômes $p_v(x), \, v \in V$. \label{item:3}     
     \end{enumerate}
