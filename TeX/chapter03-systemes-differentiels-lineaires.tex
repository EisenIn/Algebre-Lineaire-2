...
\begin{remark}
  \label{rem:8}
  Comme la démonstration du Théorème~\ref{thr:51}, où $T$ joue le rôle de $x$ et $ \mathrm{id}$ le rôle de $x^0$, on démontre:
...
\end{displaymath}
Mais $[(g_1 \cdot f_1)(T)] ( v) \in \ker(f_2(T))$  dès que 
\begin{displaymath}
  f_2(T) \circ  g_1(T) \cdot f_1(T) \cdot v =   g_1(T) \cdot f_1(T) ⋅ f_2(T) \cdot v = g_1(T) f(T) v = 0
\end{displaymath}
