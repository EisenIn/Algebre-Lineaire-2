...
\begin{proof}
  ...
  $\{v,u_2,\dots,u_n\}$ dans $\R^n$ qui orthonormale par rapport au produit scalaire ordinaire. Soit $U \in \R^{n \times n-1}$ la matrice dont les colonnes sont $u_2,\dots,u_n$.  On considère la matrice
  \begin{displaymath}
