...
\begin{lemma}
  \label{lem:30}
  Soit $k ∈ ℕ$, $λ∈ ℂ$ une valeur propre de $A ∈ℂ^{n×n}$ et $J$ une forme normale de Jordan de $A$.   Le nombre de blocs Jordan dont $λ$ est l'élément diagonal et dont la longueur est au moins $k+1$   est donné par
  \begin{displaymath}
