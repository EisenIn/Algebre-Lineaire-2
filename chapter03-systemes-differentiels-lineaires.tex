...
\begin{proof}
  ...
  \begin{displaymath}
    I, \, T, \, T^2, \dots, T^k
  \end{displaymath}
sont linéairement dépendants. Alors il existe un polynôme $p(x) \in \C[x] \setminus \{ 0 \}$ tel que $p(T) = 0$. En fait on peut choisir $p(x)$ le polynôme 
caractéristique de $T$. Le coefficient dominant de $p(x)$ est $1$.   Le théorème fondamental d'algèbre implique que 
\begin{displaymath}
