...
\begin{frame}{Algèbre Linéaire Avancée II} 
  ...
  \begin{alertblock}{Informations sur}
   ...
   \uncover<2->{
   \myemph{Notes e cours}: Disponible sur moodle.    Constamment mis à jours.

   \platz
   \myemph{À la fin du semestre}: Reflètent le contenu  relevant pour examen.
   }
   \end{frame}
   ...
   \begin{frame}
     ...
     \item Série de la semaine $n$
       ...
       \item Ce vendredi: On discute exercice $+$ semaine $1$
       \end{itemize}
     \item Séance vendredi:
       \begin{itemize}
       \item Répartition des salles affichée sur moodle (selon nom)
       \item 14 assistants (7 ass. ét. + 7 ass. doc.) à disposition pour aide, discussions. 
       \end{itemize}
   ...
   \begin{frame}{Contact et communication}
     ...
     \begin{itemize}
     \item Pour questions, commentaires: \myemph{Utilisez forum!}
     \item Assistants sont présent sur forum 
     \item \myemph{Formatez les maths en latex!} 
     \item Ne m'envoyez pas de  e-mail! 
     \item Office hours: Lundi 15:30 - 16:30. Pour rendez vous e-mail à : {\tt pauline.bataillard@epfl.ch  }
     \end{itemize}
