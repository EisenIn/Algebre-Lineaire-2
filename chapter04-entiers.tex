...
\begin{proof}
  ...
  \begin{definition}
    \label{def:49}
    Une matrice $A ∈ℤ^{m ×n}$ du rang $m$ est en \emph{forme normale de Hermite}, si elle est de la forme \eqref{eq:44}, où $r_{ii}>0$ pour tous $i$ et $0≤ r_{ij} < r_{ii}$ pour tout $i<j$. 
  \end{definition}
