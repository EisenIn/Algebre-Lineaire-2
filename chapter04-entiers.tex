...
\begin{enumerate}
\item Soit $A ∈ℤ^{m ×n}$ et $d ∈ ℤ$ un nombre entier qui divise chaque composante de $A$. Si $U ∈ℤ^{m ×m}$ et $V ∈ℤ^{n ×n}$ sont des matrices unimodulaires, alors $d$ divise chaque composante de $U⋅A⋅V$. 
\end{enumerate}
