...
\begin{definition}
  \label{def:47}
  Soit $A ∈ ℤ^{m ×n}$ une matrice. Une \emph{opération élémentaire unimodulaire} est une des deux
  \begin{enumerate}[i)]
    \item Échanger deux colonnes de $A$. 
    \item Additionner un multiple entier d'une colonne de $A$ sur une autre colonne de $A$. 
  \end{enumerate}
\end{definition}
